...
function Trainers() {
  return (
    <section className="inner-page" id="trainers">
      <section className="page-hero trainers-hero"><div><p className="eyebrow">Guidance that matters</p><h1>Meet Your <em>Coaches.</em></h1><p>Dedicated trainers committed to helping every member train with confidence and consistency.</p></div></section>
